...
class MRUCache(BaseCaching):
    """
    inherits from BaseCaching and is a Most Recently Used caching system
    """
    ...
    def put(self, key, item):
        ...
        the most recently used item in cache gets discarded
        ...
        if len(self.cache_data) >= BaseCaching.MAX_ITEMS:
            used_key = self.used_order.pop()
            del self.cache_data[used_key]
            print(f'DISCARD: {used_key}')
